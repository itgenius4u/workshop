...
public class StudentController {
    ...
    public ResponseEntity<List<Student>> getStudents(){
        ...
        students.add(new Student(1, "Dennis", "Lee"));
        students.add(new Student(2, "Dennis2", "Lee"));
        students.add(new Student(3, "Dennis3", "Lee"));
        students.add(new Student(4, "Dennis4", "Lee"));
